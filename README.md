...
- `create-workspace`\*: Creates a complete Cloud Run workspace including a new GCP project with billing. This is a comprehensive setup that prepares everything needed to start deploying to Cloud Run.
